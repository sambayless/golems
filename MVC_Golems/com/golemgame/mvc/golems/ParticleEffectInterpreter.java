...
public class ParticleEffectInterpreter extends StoreInterpreter  implements Comparable<ParticleEffectInterpreter>{
	...
	public ParticleEffectInterpreter() {
	...
	public ParticleEffectInterpreter(PropertyStore store) {
		super(store);
		super.getStore().setClassName(GolemsClassRepository.PARTICLE_EFFECTS_CLASS);
	}
	...
	public int compareTo(ParticleEffectInterpreter o) {
