...
public class GhostBoxInterpreter extends GhostInterpreter {
	...
	public GhostBoxInterpreter(PropertyStore store) {
		super(store);
		store.setClassName(GolemsClassRepository.GHOST_BOX_CLASS);
	}
	
	public GhostBoxInterpreter() {
