...
/*		   SaveManager.getInstance().newMachine();
			MachineSpace space = StateManager.getMachineSpace();
		StructuralMachine machine =	space.getMachines().get(0);*/
			...
			if (GameSettingsPanel.prompt(game.getSettings())) {
				...
				public Object call() throws Exception {
					...
					for(int e = 0;e<numBoxes;e++)
					{
						...
						StructuralAppearanceEffect structuralAppearanceEffect = new StructuralAppearanceEffect(new PropertyStore());
						
						
						BoxModel box = new BoxModel(true);
						structuralAppearanceEffect.refresh();
						//structuralAppearanceEffect.applyEffect(box);
						state.getRootNode().attachChild(box.getSpatial());
